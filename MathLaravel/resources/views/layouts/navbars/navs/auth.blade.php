            ...
            <ul class="nav navbar-nav mr-auto">
                ...
                <li class="dropdown nav-item">
                    ...
                    <ul class="dropdown-menu">
                        <a class="dropdown-item" href="#">{{ __('Login Success') }}</a>
                        <a class="dropdown-item" href="#">{{ __('Challenge Completed in time') }}</a>
                        <a class="dropdown-item" href="#">{{ __('Challenge closed time out') }}</a>
                        <a class="dropdown-item" href="#">{{ __('Challenge on pending') }}</a>

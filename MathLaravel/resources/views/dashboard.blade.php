@extends('layouts.app', ['activePage' => 'dashboard', 'title' => 'G-22 INTERNATIONAL', 'navName' => 'Dashboard', 'activeButton' => 'laravel'])
                ...
                <div class="col-md-4">
                    <div class="card ">
                        <div class="card-header ">
                            <h4 class="card-title">{{ __('Challenge Statistics') }}</h4>
                            <p class="card-category">{{ __('Last Competition Performance') }}</p>
                        </div>
                        <div class="card-body ">
                            <div id="chartPreferences" class="ct-chart ct-perfect-fourth"></div>
                            <div class="legend">
                                <i class="fa fa-circle text-info"></i> {{ __('In Time') }}
                                <i class="fa fa-circle text-danger"></i> {{ __('Timed Out') }}
                                <i class="fa fa-circle text-warning"></i> {{ __('Pending') }}
                            </div>
                            <hr>
                            <div class="stats">
                                <i class="fa fa-clock-o"></i> {{ __('Statistics sent 2 days ago') }}
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card ">
                        ...
                        <div class="card-footer ">
                            <div class="legend">
                                ...
                                <i class="fa fa-circle text-danger"></i> {{ __('No Attempt') }}
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card ">
                        <div class="card-header ">
                            ...
                            <p class="card-category">{{ __('All Mathematics Challenges Completed') }}</p>
                        </div>
                        <div class="card-body ">
                        ...
                        <div class="card-footer ">
                            <div class="legend">
                                <i class="fa fa-circle text-info"></i> {{ __('Successfully Done') }}
                                <i class="fa fa-circle text-danger"></i> {{ __('Timed Out') }}
                            </div>
                            <hr>
                            <div class="stats">
                ...
                <div class="col-md-6">
                    <div class="card  card-tasks">
                        <div class="card-header ">
                            <h4 class="card-title">{{ __('Mathematics Challenges Closed') }}</h4>
                            <p class="card-category">{{ __('Those Challenges completed') }}</p>
                        </div>
                        <div class="card-body ">

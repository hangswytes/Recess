@extends('layouts.app', ['activePage' => 'user', 'title' => 'G-22 INTERNATIONAL', 'navName' => 'User Profile', 'activeButton' => 'laravel'])
                    ...
                    <div class="col-md-4">
                        <div class="card card-user">
                            ...
                            <div class="card-body">
                                ...
                                {{ __(' Challenge Admin') }}
                                    <br> {{ __('College of Computing and Information Science') }}

    ...
    <div class="dropdown show-dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li class="button-container">
                <div class="">
                    <a href="https://www.creative-tim.com/product/light-bootstrap-dashboard-laravel" target="_blank" class="btn btn-info btn-block btn-fill">{{ __("Download our App, it's free!") }}</a>
                </div>
            </li>
            <li class="button-container">
                <div class="">
            ...
            <li class="header-title pro-title text-center">{{ __('Check More Competitions?') }}</li>
            <li class="button-container">
                <div class="">
            ...
            <li class="header-title" id="sharrreTitle">{{ __('Thank you for Contest!') }}</li>
            <li class="button-container">

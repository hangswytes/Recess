                        ...
                        <div class="col-md-8 ml-auto mr-auto">
                            <div class="card">
                                <div class="header text-center">
                                    <h4 class="title">{{ __('G-22 INTERNATIONAL PRO')}}</h4>
                                    <p class="category">{{ __('Are you looking for more overvalued math challenge competitions? Please check our Premium Version of G-22 INTERNATIONAL PRO.')}}</p>
                                    <br>
                                </div>
                                <div class="content table-responsive table-upgrade">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><h3 class="mb-0 mt-0">G-22 BEST COMPETITIONS IN MATH</h3></td>

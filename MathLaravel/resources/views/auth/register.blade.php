                            ...
                            <div class="col-md-5 ml-auto">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p>{{ __('Here you can get a free account for all the upcoming competitions, durable accounts.') }}</p>
                                    </div>
                                </div>
                                <div class="media">
                                    <div class="media-left">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p>{{ __('Here you can view all the competiton hightlights on your dashboard, let the users know what is the value that you give them.') }}</p>
                                    </div>
                                </div>
                                <div class="media">
                                    <div class="media-left">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p>{{ __('Here you can access our online Monday-Sunday customer care services.') }}</p>
                                    </div>
                                </div>
                            </div>
